  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "integer", description: "Max targets returned (1-100). Default 25. `totalTargets` counts every candidate host before this cut, so fewer targets than that means the list was truncated.", minimum: 1, maximum: 100 },
