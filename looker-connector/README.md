...
| ChatGPT / Perplexity / Gemini / Claude / Grok / AI Overviews citation rate | Average | Share of prompts on that engine that cited you (shown as a percent). |
| ChatGPT / Perplexity / Gemini / Claude / Grok / AI Overviews citations | Sum | Prompts on that engine that cited you. |
| ChatGPT / Perplexity / Gemini / Claude / Grok / AI Overviews prompts | Sum | Prompts tested on that engine. |
| ChatGPT / Perplexity / Gemini / Claude / Grok / AI Overviews avg position | Average | Average rank of your mention when cited. |
